...
export function Sidebar() {
  ...
  return (
    <div
      className={`h-screen bg-white border-r border-gray-200 transition-all duration-300 flex flex-col ${sidebarCollapsed ? 'w-20' : 'w-60'}`}>
      ...
      <Menu
        ...
        className={`flex-1 border-none ${sidebarCollapsed ? 'w-20' : 'w-60'}`}
